...
public:
   ...
   *
   */
  void init(joint_traj_pt_full_ex::JointTrajPtFullEx &group);
   ...
   */
  void setSequence(industrial::shared_types::shared_int sequence) { group_.setSequence(sequence); }

  industrial::joint_traj_pt_full_ex::JointTrajPtFullEx group_;
...
#endif // JOINT_TRAJ_PT_FULL_EX_MESSAGE_H
