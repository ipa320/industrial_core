...
void JointTrajPtFullExMessage::init(industrial::joint_traj_pt_full_ex::JointTrajPtFullEx & group)
{
  this->init();
  this->group_.copyFrom(group);
}
